    ...
    <div>
      <div className="col-span-1">
        <div className="flex flex-col relative">
          <div className="skeleton max-w-[300px] min-h-[300px] max-h-[300px] bg-grey-200 rounded-2xl"></div>
          <div className="skeleton max-w-[300px] min-h-[20px] max-h-[20px] bg-grey-200 rounded mt-4"></div>
