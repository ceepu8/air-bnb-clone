...
function _axiosMethod(method: Methods) {
  return Axios[method] // works
  // ...
}

// eslint-disable-next-line consistent-return
async function request({ method = "get", url, query, params, success, failure, headers }: any) {
...
async function fetch({ method = "get", url, query, params, headers, moreOptions = {} }: any) {
